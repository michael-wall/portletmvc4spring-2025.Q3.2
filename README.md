...
```
- Due to a pending fix in Liferay DXP 2025.Q3.x (expected to be 2025.Q3.3) for https://liferay.atlassian.net/browse/LPD-64760 it is necessary to temporarily remove ALL references to the functions taglib following in .jsp and .jspx files e.g.:
```
